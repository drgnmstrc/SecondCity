...
/client/set_client_age_from_db()
	. = ..()
	log_client_to_db_connection_log(ckey, address, computer_id, byond_version, byond_build)
...
/proc/log_client_to_db_connection_log(ckey, address, computer_id, byond_version, byond_build)
